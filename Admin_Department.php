...
<div class="sidenav">
    ...
    <a href="Admin_Department.php"  class="selected">Departments</a>
...
<!-- Modal content -->
    ...
    <form name="PopUp" action="">
                    ...
                    <h4>Department Name<span style="color:var(--color-red)">*</span></h4>
                    <input type="text" placeholder="Department Name">
                    </div>

                    <div class="div2_Popup">
                    <h4>Leader Name<span style="color:var(--color-red)">*</span></h4>
                    <input type="text" placeholder="Leader Name">
                    </div>
                    
                    <div class="div2_Popup">
                    <div>
                        <h4>Photo<span style="color:var(--color-red)">*</span></h4>
